...
namespace ytd.Downloader
{
    internal enum DownloadStatus { None, Downloading, Paused, Success, Failed, Canceled }

    /// <summary>
    /// Downloads and resumes files from HTTP, FTP, and File (file://) URLS
    /// </summary>
    internal class FileDownloader : AbortableBackgroundWorker
    {
        ...
        private bool _pause;
        private static long SecondTicks = TimeSpan.FromSeconds(1).Ticks;
    ...
    /// <summary>
    /// Constains the connection to the file server and other statistics about a file that's downloading.
    /// </summary>
    public class DownloadData
    {
        ...
        public static DownloadData Create(string url, string destFolder, String fileName, IWebProxy proxy)
        {
            ...
            // Check to make sure the response isn't an error. If it is this method will throw exceptions.
        ...
        /// <summary>
        /// Checks the file size of a remote file. If size is -1, then the file size could not be determined.
        /// </summary>
